...
class RoleWebAdapterTest {
    ...
    void save() throws Exception {
        ...
        assertThat(ac.getValue().getDescription()).isEqualTo("특급 권한");
        assertThat(ac.getValue().getChildren().size()).isEqualTo(1);
        assertThat(ac.getValue().getChildren().get(0).getRole()).isEqualTo(ROLE_USER);
        assertThat(ac.getValue().getChildren().get(0).getDescription()).isEqualTo("유저 권한");
        assertThat(ac.getValue().getChildren().get(0).getChildren()).isEmpty();
    }
    ...
    void update() throws Exception {
        ...
        assertThat(ac.getValue().getChildren()).isEmpty();
    }
